...
本文件描述 Turtle 治理控制面需求。Turtle 与 Whale 并列，负责治理、安全、审计、合规、策略、部署准入和变更控制。
...
| P-AR-003 | 承接 Turtle 与 Whale/PlatformShared 的边界 |
...
| TU-AR-001 | P-AR-003 | Turtle 与 Whale 并列 | AR | 高 | turtle | L1 | 已验证 | src/turtle 与 src/whale 并列 | import boundary tests | 无 | 无 | 2026-06-02 |
