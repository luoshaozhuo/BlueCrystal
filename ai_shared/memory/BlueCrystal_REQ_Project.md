...
| P-AR-002 | - | 生产路径与工具路径分离 | AR | 高 | Project | P4 | 已验证 | ingest 不直接依赖 source_lab；source_lab runner 存在不等于 production client 完成；shared_source production runner artifact 与 source_lab build 边界明确 | test_ingest_no_source_lab_imports, test_turtle_octopus_import_boundary, shared_source runner boundary evidence | 无 | 持续维护 | 2026-06-03 |
