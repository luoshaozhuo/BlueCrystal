...
class TdengineStandardizedWaveformSink(StandardizedWaveformSinkPort):
    ...
    def __init__(
        ...
        *,
        ...
        """
        from whale.storage.raw_index import _parse_tdengine_dsn
    ...
    async def write(
        ...
        *,
        ...
        from whale.storage.raw_index import _escape_sql_val, _safe_table_name
    ...
    async def readback(
        ...
        if not self._ensure_initialized():
            return []
        try:
            from whale.storage.raw_index import _safe_table_name
