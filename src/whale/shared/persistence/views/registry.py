...
from whale.shared.persistence.views.scada_protocol_views import SCADA_PROTOCOL_VIEW_DEFINITIONS
from whale.shared.persistence.views.scada_server_view import SCADA_SERVER_VIEW
