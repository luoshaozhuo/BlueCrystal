...
from starfish.domain.protocols.iec101.ioa import IOA_LENGTH, decode_information_object_address
...
def encode_asdu(asdu: Asdu) -> bytes:
    ...
    if asdu.header.sq:
        ...
        from starfish.domain.protocols.iec101.ioa import encode_information_object_address
