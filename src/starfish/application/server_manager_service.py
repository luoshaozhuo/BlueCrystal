...
from starfish.drivers.server_registry import ServerRegistry, create_server_registry
...
class StarfishServerManagerService:
    ...
    def load_config(self, input_path: Path) -> LoadedConfig:
        ...
        """
        result = load_server_config(input_path)
    ...
    def build_manager(self, input_path: Path) -> BuiltManager:
        ...
        return BuiltManager(
            ...
            validation=loaded.validation,
            registry=create_server_registry(loaded.config),
        )
