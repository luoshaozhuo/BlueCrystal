...
from pacific.whale.ingest.config import CONFIG, PostgresDatabaseConfig, SqliteDatabaseConfig
from pacific.whale.ingest.framework.persistence.session import engine
...
def initialize_db(*, insert_sample_data: bool) -> None:
    ...
    from pacific.whale.shared.persistence import Base as SharedBase
...
def load_default_sample_data() -> None:
    ...
    from pacific.whale.shared.persistence.sample_data import generate_all_sample_data
