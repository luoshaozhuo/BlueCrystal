...
from pacific.whale.ingest.framework.persistence.session import session_scope
...
from pacific.whale.ingest.usecases.dtos.source_acquisition_request import AcquisitionItemData
