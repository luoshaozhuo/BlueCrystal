...
from pacific.whale.ingest.runtime.job_assignment import RuntimeJob, RuntimeJobRepository
from pacific.whale.shared.persistence.orm import IngestRuntimeJob
