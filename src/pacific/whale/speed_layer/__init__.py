...
from pacific.whale.speed_layer.light_processor import (
    EnvelopeValidator,
...
from pacific.whale.speed_layer.metrics import (
    InMemoryMetricsCollector,
    MetricsCollectorPort,
)
from pacific.whale.speed_layer.preprocessing import (
    BinaryDecoderStub,
    DecodedSignal,
...
from pacific.whale.speed_layer.runner import (
