...
from pacific.whale.message_pipeline.model import Envelope, MessageOffset, TopicSpec
from pacific.whale.message_pipeline.ports import (
    DeadLetterSinkPort,
    MessageSourcePort,
)
from pacific.whale.speed_layer.light_processor import LightProcessingPipeline
from pacific.whale.speed_layer.writers import (
    RawArchiveWriter,
    RawIndexWriter,
    ServingCacheUpdater,
    StandardizedWriter,
)
from pacific.whale.storage.raw_archive import LocalCompressedArchiveSink
...
class SpeedLayerWiring:
    ...
    def with_memory(self) -> "SpeedLayerWiring":
        ...
        from pacific.whale.storage.raw_archive import InMemoryManifestRepository
        from pacific.whale.storage.raw_index import MemoryRawIndexSink
    ...
    def with_kafka_source(
        ...
        Returns:
            self，支持链式调用。
        """
        from pacific.whale.message_pipeline.adapters.kafka import KafkaSourceAdapter
    ...
    def with_s3_archive(
        ...
        Returns:
            self，支持链式调用。
        """
        from pacific.whale.storage.raw_archive import S3RawArchiveSink, S3ManifestRepository
    ...
    def with_tdengine_index(
        ...
        Returns:
            self，支持链式调用。
        """
        from pacific.whale.storage.raw_index import TdengineRawIndexSink
    ...
    def with_tdengine_standardized(
        ...
        Returns:
            self，支持链式调用。
        """
        from pacific.whale.storage.standardized import TdengineStandardizedSink
    ...
    def with_redis_cache(
        ...
        Returns:
            self，支持链式调用。
        """
        from pacific.whale.storage.serving_cache import RedisServingCache
    ...
    def with_inmemory_dlq(self) -> "SpeedLayerWiring":
        ...
        Returns:
            self，支持链式调用。
        """
        from pacific.whale.message_pipeline.adapters.in_memory import InMemoryDeadLetterSink
